...
export class Row {
    ...
    createNewRow(){
        ...
        this.data[idxNull]=0; // chắc chắn có 1 ô null
        var idxS=getRandomElementsFromArray(this.idx,1)[0];
        this.data[idxS]=this.count; // chắc chắn có 1 ô điểm bình thường
